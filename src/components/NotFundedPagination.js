...
export default function NotFundedPagination({
        ...
        let readMoreDescription = (
          ...
          <>
            {viewedDescription.length > 300 ? (
              ...
              //if the description is under 30 characters just show the description without a read more button
              <>{viewedDescription}</>
            )}
          </>
        );
  ...
  useEffect(() => {
    ...
    //checking list length for pagination pages and no items display
